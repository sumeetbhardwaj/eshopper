...
<header id="header" style="margin-bottom:15px;"><!--header-->
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-12">
						...
						<a class="navbar-brand" href="index.php"><img  class="img img-responsive" src="images/home/logo.png" style="width:100%" alt="" /></a>
		...
		<div class="container">
			<img src="images/shop/advertisement.jpg" class="img img-responsive" alt="" />
		</div>
